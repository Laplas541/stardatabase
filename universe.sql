...
ALTER SEQUENCE public.blackhole_bkackhole_id_seq OWNED BY public.blackhole.bkackhole_id;
...
--
-- Name: blackhole bkackhole_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.blackhole ALTER COLUMN bkackhole_id SET DEFAULT nextval('public.blackhole_bkackhole_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.blackhole_bkackhole_id_seq', 1, false);
...
ALTER TABLE ONLY public.blackhole
    ADD CONSTRAINT blackhole_pkey PRIMARY KEY (bkackhole_id);
